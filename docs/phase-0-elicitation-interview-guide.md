...
### Filmmaking Panel (Market & Distribution)
- "Which audience, festival, or distribution thresholds feel make-or-break?"  
- "Where do you expect the film to compound vs stall (word of mouth, awards, franchise potential)?"

### Filmmaking Panel
- "What is the creative truth or emotional promise you refuse to compromise?"  
- "Set an art vs commercial weight (0-100 each)."
- "Which focus should lead this session: writing, production, fundraising, or market?"
