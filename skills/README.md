# Skills for Filmmaking Panel

This directory contains skills required for the Filmmaking Panel to function properly.

## worldview-elicitor

The worldview-elicitor skill is used in Phase 0 to understand how the user thinks about the decision context before evaluation.
...
The skill is invoked automatically by the moderator during Phase 0 using:
...
If you develop additional skills for the Filmmaking Panel, add them to this directory following the same structure:
